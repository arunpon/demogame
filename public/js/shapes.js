var GAME_UTIL = (function() {
  ...
  return {
    ...
    getShapeCount: function(i) {
      return SHAPE_COUNT[i];
    },
    getShapeColor: function(i) {
      return SHAPE_COLOR[i];
    },
    getShapeFillType: function(i) {
      return SHAPE_FILLTYPE[i];
    },
...
var GAME_MODEL = (function() {
  ...
  return {
    tileAttributes: function() {
      return gameArrayAttributes
    },
    populatedSet: function() {
      return setArrayAttributes
    },
    populatedSetIndexes: function() {
      return setArrayIndexes
    },
    tilesSelected: function() {
      return selectedTiles
    },
    emptySelectedTiles: function() {
      selectedTiles = new Object()
    }
  };
})();